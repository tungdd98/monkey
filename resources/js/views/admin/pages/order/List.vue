<template>
	<div class="v-products">
        ...
        <el-table-column label="Trạng thái">
          <template slot-scope="scope">
						<div class="v-h2" v-html="showStatus(scope.row)">{{ showStatus(scope.row) }}</div>
					</template>
        </el-table-column>
					...
					<template slot-scope="scope">
						<el-dropdown>
							...
							<el-dropdown-menu slot="dropdown">
								<el-dropdown-item>
                  <span @click="handleChangeStatus(scope.row, 0)">Chưa giao hàng</span>
                </el-dropdown-item>
								<el-dropdown-item>
                  <span @click="handleChangeStatus(scope.row, 1)">Đang giao hàng</span>
                </el-dropdown-item>
								<el-dropdown-item>
                  <span @click="handleChangeStatus(scope.row, 2)">Hoàn tất</span>
                </el-dropdown-item>
								<el-dropdown-item>
                  <span @click="handleChangeStatus(scope.row, 3)">Huỷ đơn hàng</span>
                </el-dropdown-item>
							</el-dropdown-menu>
						</el-dropdown>
						<el-button
