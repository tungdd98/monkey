          ...
          <el-form :model="form" :rules="rules" :ref="controller">
            <el-row :gutter="20">
              ...
              <el-col :span="8">
                ...
                <el-form-item label="Ảnh đại diện" :label-width="display.formLabelWidth" prop="thumbnail">
                  <el-upload
                    action="/"
                    ref="upload"
                ...
                <el-form-item label="Tác giả" :label-width="display.formLabelWidth" prop="author">
                  <el-input v-model="form.author" autocomplete="off">
                    <i slot="suffix" class="el-input__icon el-icon-edit"></i>
                  </el-input>
                </el-form-item>
                <el-form-item label="Bút danh" :label-width="display.formLabelWidth" prop="pseudonym">
                  <el-input v-model="form.pseudonym" autocomplete="off">
                    <i slot="suffix" class="el-input__icon el-icon-edit"></i>
                  </el-input>
                </el-form-item>
                <el-form-item label="Nguồn" :label-width="display.formLabelWidth" prop="source">
