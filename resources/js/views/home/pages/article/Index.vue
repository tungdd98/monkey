  ...
  <section class="page-news page-primary">
    <div class="container">
      ...
      <div class="list-news" v-if="items && items.length">
        <div class="row">
          <div class="col-md-6" v-for="item in items" :key="item.id" :item="item">
            <div class="item-news">
              <router-link :title="_slug(item.title)" :to="getLinkItem(item)" class="img-primary">
                <img :src="_getThumbnail('article', item.thumbnail)" alt />
              </router-link>
              <div class="ct">
                <h3 class="title">
                ...
                <div class="control">
                  <span class="time">
                    ...
                    {{ _dateFormat(item.created_at, 'short') }}
                  </span>
