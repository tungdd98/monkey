<template>
	<section class="page-primary v2">
		<div class="container">
			<h2 class="head-primary v2">Liên hệ</h2>
			<div class="row">
				<div class="col-lg-5">
					<div class="form-contact">
						<h3 class="title-contact">Gửi email cho chúng tôi</h3>
					...
					<div class="info-contact">
						...
						<ul>
							<li>
								...
								<p>
									<strong>Địa chỉ 1:</strong> VB2-BT5 Lưu Hữu Phước, Mỹ Đình 2, Hà Nội
								</p>
							</li>
							<li>
							...
							<li>
								...
								<p>
									<strong>Giờ mở cửa:</strong> 07:00 - 21:00 từ T2 - CN
								</p>
							</li>
						</ul>
					</div>
